...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
	...
	G4VSolid* sol_RepX = new G4Box("RepX",(WaterBoxX/100)*0.5,WaterBoxY*0.5,WaterBoxY*0.5);
	...
	G4VSolid* sol_RepZ = new G4Box("RepZ",(WaterBoxX/100)*0.5,WaterBoxY*0.5,(WaterBoxZ/100)*0.5);
	G4LogicalVolume* lv_RepZ = new G4LogicalVolume(sol_RepZ,WATER,"RepZ");
	G4VPhysicalVolume* pv_RepZ = new G4PVReplica("RepZ",lv_RepZ,lv_RepX,kZAxis,NumOfReplica,WaterBoxZ/NumOfReplica);
